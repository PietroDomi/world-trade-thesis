...
\begin{figure}
    ...
    \caption[Long term trends of trade exchanges across EU member countries]{Long term trends of trade exchanges across EU member countries, by various indicators: (1) value (€), (2) quantity (Kg), (3) price (€/kg).}
    \label{fig:totaleu}
\end{figure}
...
% so i have this
% y prod from to €/1000p 
% why value and not quantity
% i want to do graph
% nodes: countries fixed
% edges: exchanges normalized
% type of: directed, multilayer, weighted/un
% plot with without wto
...
\begin{itemize}
    \item \textit{Year}: indicating the period of the aggregated exchanges;
